...
Cilj ovog sistema jeste da olakša funkcionisanje jednog online restorana. To se postiže međusobnom komunikacijom korisnika, koordinatora kao i oso\-ba zaduženih za pripremu i distribuciju hrane. Na taj način realizuju se zahtevi korisnika u najkraćem vremenskom roku sa što boljim kvalitetom usluga.
%\subsection{Dijagram konteksta}

Na narednoj slici (Slika \ref{fig:dij_konteksta}) nalazi se dijagram konteksta koji grafički prikazuje osnovne aktere u sistemu i veze medju njima.
...
Sledeci DTP dijagram nivoa jedan (Slika \ref{fig:dtp})  predstavlja osnovne celine koje smo uočili. 
% \begin{center}
