...
\begin{itemize}
 ...
 \begin{figure}[!h]
    ...
    \caption{Utisci} % opis ce stajati ispod slike
...
\end{figure}
 ...
 \begin{figure}[!h]
    ...
    \caption{Dodavanje ocene} % opis ce stajati ispod slike
...
\item \textbf {Alternativni tokovi}:\\
 ...
 \begin{figure}[!h]
    ...
    \caption{Nalozi zaposlenih} % opis ce stajati ispod slike
    \label{fig:slika_nalozi}
\end{figure}

 \begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/menadzer_noviNalog.PNG}
    \caption{Kreiranje naloga zaposlenog} % opis ce stajati ispod slike
    \label{fig:slika_nalozi}
\end{figure}

\begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/menadzer_nalog.PNG}
    \caption{Nalog zaposlenog} % opis ce stajati ispod slike
...
\item \textbf{Dodatne informacije}
 ...
 \begin{figure}[!h]
    ...
    \caption{Deaktiviranje naloga otpuštenog radnika} % opis ce stajati ispod slike
...
\subsection{Upravljanje porudžbinom}
 ...
 \begin{figure}[!h]
    ...
    \caption{Dijagram slučajeva upotrebe} % opis ce stajati ispod slike
    \label{fig:slika_deaktiviranje}
\end{figure}
...
Na slici \ref{fig:slika14} je predstavljen dijagram stanja koji opisuje opšti tok upra\-vljanja porudžbinom. U zavisnosti od toga da li među zalihama ima dovoljno namirnica, porudžbina se prihvata ili odbija.
\begin{figure}[!h]
    \leavevmode
    \begin{center}
...
\begin{figure}[!h]
    ...
    \caption{Naručivanje telefonom} % opis ce stajati ispod slike
    \label{fig:slika_kontakt}
\end{figure}
\begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/raspolozivost_namirnica.png}
    \caption{Raspolo\v zivost namirnica} % opis ce stajati ispod slike
    \label{fig:slika_kontakt}
\end{figure}
\begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/nedovoljno_namirnica.png}
    \caption{Nema potrebnih namirnica} % opis ce stajati ispod slike
    \label{fig:slika_kontakt}
\end{figure}
...
\item \textbf{Alternativni tokovi}\\
 ...
 \begin{figure}[!h]
    ...
    \caption{Zahtev za odmorom} % opis ce stajati ispod slike
    \label{fig:slika_odmor}
\end{figure}
 \begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/odmor1.png}
    \caption{Obrada zahteva} % opis ce stajati ispod slike
    \label{fig:slika_obrada1}
\end{figure}

 \begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/odmor2.png}
    \caption{Provera zahteva nakon obaveštenja} % opis ce stajati ispod slike
...
\end{itemize}
 ...
 \begin{figure}[!h]
    ...
    \caption{Zahtev za neplaćenim odmorom} % opis ce stajati ispod slike
...
\end{figure} 
 ...
 \begin{figure}[!h]
    ...
    \caption{Zahtevi za  odmorom} % opis ce stajati ispod slike
    \label{fig:slika_odmor}
\end{figure}
\vspace{5cm}
\begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/menadzer_proveraStanja.PNG}
    \caption{Provera rasporeda odsustva radnika} % opis ce stajati ispod slike
...
\item \textbf{Alternativni tokovi}\\
 ...
 \begin{figure}[!h]
    ...
    \end{center}
    \caption{Stanje magacina} % opis ce stajati ispod slike
    \label{fig:slika8}
\end{figure}
 ...
 \begin{figure}[!h]
    ...
    \end{center}
    \caption{Naručivanje namirnice} % opis ce stajati ispod slike
    \label{fig:slika8}
\end{figure}
...
\end{itemize}
 ...
 \begin{figure}[!h]
    ...
    \end{center}
    \caption{Spisak naručenih namirnica} % opis ce stajati ispod slike
