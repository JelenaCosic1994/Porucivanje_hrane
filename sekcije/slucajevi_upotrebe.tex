...
\begin{itemize}
 ...
 \begin{figure}[!h]
    ...
    \caption{Nalog za kuvara, dekoratera i dostavljača} % opis ce stajati ispod slike
 ...
 \begin{itemize}
   ...
   Radniku koji je otpušten menadžer deaktivira nalog kako više ne bi imao pristup sistemu.
    ...
    \begin{enumerate}
        ...
        \item Menadžer potvrđuje unete promene klikom na  'OK' u iskačućoj poruci.
...
\end{itemize}
 \begin{figure}[!h]
    \includegraphics[width=1\textwidth]{slike/menadzer_zahteviZaOdmorom.PNG}
...
\begin{figure}[!h]
    ...
    \caption{Provera rasporeda odmora radnika} % opis ce stajati ispod slike
